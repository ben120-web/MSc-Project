# This script allows a used to select a model to test with the dataset.

import torch
import torch.optim as optim
from ecgdetectors import Detectors
from data_loading import load_data
from models import CNN # Update this for any model.
import math
...
# Load the data
dataloader = load_data(clean_signals_path, noisy_signals_path, segment_length = 1500, batch_size = 1, num_workers=2)
